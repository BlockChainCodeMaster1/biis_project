    ...
    <div className="container mx-auto max-w-7xl px-6 flex-grow">
      ...
      <section className=" relative z-10">
        <section className="flex flex-col items-center justify-center gap-4 ">
          <div className="text-base sm:text-2xl py-2 sm:py-10">
            Improve your
          </div>
            ...
            <Card className=" w-full">
              <CardBody className="p-4 sm:p-6 bg-[url(/home/toolsBox-arrow.svg)] bg-no-repeat bg-[length:5rem_auto] sm:bg-[length:10rem_auto] bg-[right_96%] ">
                ...
                <p className="text-[#989EAF] text-xs sm:text-lg py-2 sm:py-8 sm:h-60">
                  ...
                  The Seamless Integration With The Ordinals Protocol Ensures
                  That Users Fully Leverage The Advantages Of The BRC-20
                  Standard And Ordinals Protocol When Using The Toolbox.
                </p>
                <p className=" py-4">
                  <Button
                    size="lg"
            ...
            <Card className=" w-full bg-white bg-[url(/home/cardIcon1.svg)] bg-no-repeat  bg-[length:2.5rem_auto]  sm:bg-[length:4rem_auto] bg-[position:6%_6%]">
              <CardBody className=" p-4 sm:p-10 pt-14 sm:pt-24 ">
                ...
                <p className="text-[#989EAF] text-xs sm:text-lg py-2 sm:py-8">
                  ...
                  Performing Batch Collection From Multiple Source Addresses.
                  This Simplifies The Management And Liquidity Operations Of
            ...
            <Card className=" w-full bg-white bg-[url(/home/cardIcon3.svg)] bg-no-repeat bg-[length:2.5rem_auto]  sm:bg-[length:4rem_auto] bg-[position:6%_6%]">
              <CardBody className=" p-4 sm:p-10 pt-14 sm:pt-24 ">
                ...
                <p className="text-[#989EAF] text-xs sm:text-lg py-2 sm:py-8">
                  ...
                  Transactions At Once, Enhancing Efficiency, Reducing
                  Transaction Costs, And Offering Users A More Flexible Way Of
                  Operation. Users Can Conveniently And Securely Manage And
                  Execute Complex Bitcoin Transactions.
                </p>
              </CardBody>
            </Card>
            <Card className=" w-full bg-white bg-[url(/home/cardIcon4.svg)] bg-no-repeat bg-[length:2rem_auto]  sm:bg-[length:4rem_auto] bg-[position:6%_8%]">
              <CardBody className=" p-4 sm:p-10 pt-14 sm:pt-24 ">
                ...
                <p className="text-[#989EAF] text-xs sm:text-lg py-2 sm:py-8">
                  ...
                  Allowing Users To Cross Different Blockchain Platforms,
                  Achieve Seamless Transfer Of Assets, And Enhance
                  Interoperability, Thus Improving The Liquidity Of Digital
                  Assets.
                </p>
              </CardBody>
            </Card>
