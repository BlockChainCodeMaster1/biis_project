...
export const SidebarWrapper = tv({
  base: "bg-background overflow-hidden transition-transform h-full fixed -translate-x-full w-full shrink-0 z-[202] overflow-y-auto border-r border-divider flex-col py-6 md:ml-0 md:flex md:static md:h-screen md:translate-x-0 ",
